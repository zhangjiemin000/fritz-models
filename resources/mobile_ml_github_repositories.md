...
[ObjectDetection](https://github.com/skafos/ObjectDetection) | 2019-02-28 | 0 | Example app that uses the Skafos platform for CoreML model integration and delivery.	
...
[Object-Detecting-Example](https://github.com/SmartyToe/Object-Detecting-Example) | 2019-02-15 | 0 | Example of using CoreML
...
[smartrice-mobile](https://github.com/marcreyesph/smartrice-mobile) | 2019-02-21 | 0 | A mobile application using DCNN for detecting and mapping rice plant diseases and infestations.
...
[TechniqueAnalysis](https://github.com/trevphil/TechniqueAnalysis) | 2019-02-18 | 0 | CocoaPod to analyze body motion and exercise technique
...
[PoseEstimationForMobileInJava](https://github.com/sauvignon1989/PoseEstimationForMobileInJava) | 2019-01-27 | 0 | Java Replica of PoseEstimationForMobile ( https://github.com/edvardHua/PoseEstimationForMobile )
...
[ARML](https://github.com/giln/ARML) | 2019-02-22 | 0 | ARKit and CoreML fun
...
[Twitter-AI-Anlyzr](https://github.com/NFestoso/Twitter-AI-Anlyzr) | 2019-02-21	 | 0 | Use Apple's CreateML AI model to analys the emotional sum of a specified Twitter handle or hashtag.
...
[tutorial-projects](https://github.com/Philosocode/tutorial-projects)	| 2019-02-14 | 0 | Tutorial projects from Udemy, YouTube, and other sources.
...
[ImageClassifier](https://github.com/skafos/ImageClassifier) | 2019-02-28 | 0 | Example app that uses the Skafos platform for CoreML model integration and delivery.
[Udemy-Project-Files](https://github.com/bsakhuja/Udemy-Project-Files) | 2019-02-27 | 0 | Miscellaneous projects accrued from doing various Udemy courses.
...
[SeeFood](https://github.com/Brandon-316/SeeFood) | 2019-02-27 | 0 | App Brewery bootcamp project 16 ('Silicon Valley' inspired app with InceptionV3 Machine Learning Model.)	
[CoreML-Image-Recognition](https://github.com/dbystruev/CoreML-Image-Recognition) | 2019-02-26 | 0	
[TFLiteClassificationApp](https://github.com/adiliqbl/TFLiteClassificationApp) | 2019-02-26 | 0 | Sample application to test TensorFlow Lite models on android
...
[HackUTD](https://github.com/kevinjnguyen/HackUTD) | 2019-02-24 | 0 | HackUTD feat. TAMUhack
[echocardiography](https://github.com/ductm104/echocardiography) | 2019-02-24 | 0	
[PSSwiftML](https://github.com/pacts/PSSwiftML) | 2019-02-24 | 0 | A swift machine learning demo about image recognition
...
[TreeLibrary](https://github.com/MertalpTasdelen/TreeLibrary) | 2019-02-21 | 0 | It a Turkish resources about forest in Turkey
...
[What-Flower-](https://github.com/jondesam/What-Flower-) | 2019-02-19 | 0 | detecting flower converting Caffe model ML(CoreML, Alamofire, SwiftyJSON, SDWebImage...)
[Core-ML-example](https://github.com/razvanrujoiu/Core-ML-example) | 2019-02-19 | 0 | An example of using Core-ML library, AVCaptureSession, AVCapturePhotoOutput, AVSpeechSynthesizer
...
[SeeFood](https://github.com/PaulWThi/SeeFood) | 2019-02-16 | 0 | Utilizes Inception3 Core ML Model to check user photo capture is a hotdog.
...
[sobr](https://github.com/parsadastjerdi/sobr) | 2019-02-15 | 0 | Preventing drunk driving through image classification of intoxicated drivers
...
[TrashBinCode](https://github.com/Ruqyai/TrashBinCode) | 2019-02-13 | 0 | Using Tensorflow for training model to detect real time objects and recognize which type any trash belong
[ILoveNumbers](https://github.com/vinpala/ILoveNumbers) | 2019-02-26 | 0 | This repository contains code for training a Keras model to recognize digits and using the model(converted to TFlite) in an android app. The model is hosted on Firebase, also shipped locally. The app uses the ML Kit Custom Model API for downloading the model and run inference.
[recognition](https://github.com/lauramdelarosa/recognition) | 2019-02-15 | 0	
[AR-Object-Identification](https://github.com/S-m1tty/AR-Object-Identification) | 2019-02-14 | 0 | NASA H.U.N.C.H. Program - Augmented Reality Object Identification
...
[MobileNetApp-CoreML](https://github.com/tucan9389/MobileNetApp-CoreML) | 2019-02-27 | 0 | Core ML을 사용하여 MobileNet.mlmodel을 실행시켜본 예제입니다.

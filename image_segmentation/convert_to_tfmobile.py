...
from image_segmentation import icnet

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger('convert_to_tfmobile')
...
def main(argv):
    ...
    parser.add_argument(
        ...
        help='Weights from a trained Image Segmentation Network.'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='The size of the input image. Input images are assumed square.'
    )
    parser.add_argument(
        '--num-classes', type=int, required=True,
        help='The number of classes segmented (including background class).'
    )
    parser.add_argument(
    ...
    keras_model = icnet.ICNetModelFactory.build(
        args.image_size,
        args.num_classes,
        alpha=args.alpha,
    ...
    # Freeze Graph
    _freeze_graph(keras_model, basename, args.output_dir)
    # Optimize Graph
